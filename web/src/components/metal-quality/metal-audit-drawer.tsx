...
import { useMetalAudit } from "@/lib/queries";
...
export function MetalAuditDrawer({
  metalBatchNumber,
  open,
  onOpenChange,
}: {
  ...
  const { data } = useMetalAudit(metalBatchNumber);
      ...
      <SheetContent side="right" size="xl" className="!max-w-[640px]">
        <SheetHeader>
          <div className="flex items-center gap-2">
            ...
            <SheetTitle>Audit trail · {metalBatchNumber}</SheetTitle>
          </div>
          <SheetDescription>
            Every mutation across the metal batch, samples, tests and chemistry results. Field-level diffs preserved.
          </SheetDescription>
