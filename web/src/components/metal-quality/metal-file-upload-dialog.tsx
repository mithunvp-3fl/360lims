...
import { useMetalFileUpload } from "@/lib/queries";
import type { MetalTest } from "@/lib/types";
import { cn } from "@/lib/utils";

const PHASES = [
  { label: "File uploaded", delay: 600 },
  { label: "Extracting chemistry…", delay: 900 },
  { label: "Validation complete", delay: 700 },
];

export function MetalFileUploadDialog({
  metalBatchNumber,
  test,
  open,
  onOpenChange,
  ...
  const upload = useMetalFileUpload(metalBatchNumber);
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Upload chemistry file
          </DialogTitle>
          <DialogDescription>
            Supported formats: PDF, CSV, Excel, image scans. The file is parsed and validated against the grade spec.
          </DialogDescription>
        </DialogHeader>
