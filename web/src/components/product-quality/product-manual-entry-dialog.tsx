...
import { useProductManualEntry } from "@/lib/queries";
...
export function ProductManualEntryDialog({
  productBatchNumber,
  test,
  open,
  onOpenChange,
  ...
  const mutate = useProductManualEntry(productBatchNumber);
  ...
  function submit(e: React.FormEvent) {
    ...
    try {
      ...
      mutate.mutate(
        ...
        {
          onSuccess: () => {
            toast.info("Manual result saved", {
