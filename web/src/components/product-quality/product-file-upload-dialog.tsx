...
import { useProductFileUpload } from "@/lib/queries";
import type { ProductTest } from "@/lib/types";
import { cn } from "@/lib/utils";

const PHASES = [
  { label: "File uploaded", delay: 600 },
  { label: "Extracting results…", delay: 900 },
  { label: "Validation complete", delay: 700 },
];

export function ProductFileUploadDialog({
  productBatchNumber,
  test,
  open,
  onOpenChange,
  ...
  const upload = useProductFileUpload(productBatchNumber);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Supported formats: PDF, CSV, Excel, image scans. The file is parsed and validated against spec.
          </DialogDescription>
        </DialogHeader>
