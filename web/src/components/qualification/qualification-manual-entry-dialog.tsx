...
import { useQualificationManualEntry } from "@/lib/queries";
...
export function QualificationManualEntryDialog({
  qualificationNumber,
  test,
  open,
  onOpenChange,
  ...
  const mutate = useQualificationManualEntry(qualificationNumber);
